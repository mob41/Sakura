...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Permissions Management</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            	...
            	<div class="col-lg-12">
            		<div class="panel panel-danger">
            			...
            			<div class="panel-body">
            				Central permission management is not implemented. Instead, you can use User Management to manage user related permissions.
            			</div>
            		</div>
            	</div>
            </div>
