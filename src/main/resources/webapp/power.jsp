...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Power Usage Management</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-danger">
                    	<b>Warning:</b> Unregistering PowerUse instances may crash the system with errors. Besides, it also affects the calculation of total/real-time power usage. Do not unregister any of them unless you know what are you doing.
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        	...
                        	<div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody><% PowerUse powerUse; for (int i = 0; i < currRecordStrs.length; i++){ powerUse = currRecord.getPowerUses()[i]; %>
                                    	<tr>
                                    		<td><input type="button" class="btn btn-danger" value="Unregister" /></td>
