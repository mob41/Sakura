...
public class Session {
	...
	public boolean equals(Session anotherSession){
		return this.user.equals(anotherSession.user) 
				&& this.ip.equals(anotherSession.ip)
				&& this.sessionkey.equals(anotherSession.sessionkey)
				&& this.regtime == anotherSession.regtime
				&& this.timeout == anotherSession.timeout;
	}
